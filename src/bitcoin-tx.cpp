...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s KoreaWon-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  KoreaWon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KoreaWon transaction") + "\n" +
              "  KoreaWon-tx [options] -create [commands]   " + _("Create hex-encoded KoreaWon transaction") + "\n" +
              "\n";
