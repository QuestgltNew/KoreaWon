...
const char * const BITCOIN_CONF_FILENAME = "KoreaWon.conf";
const char * const BITCOIN_PID_FILENAME = "KoreaWond.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KoreaWon";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/KoreaWon";
#else
    // Unix
    return pathRet / ".KoreaWon";
#endif
#endif
}
