...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.KoreaWon.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.KoreaWontools.com");
        vSeeds.emplace_back("dnsseed.KoreaWonpool.org");
        ...
        fDefauKRWonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.KoreaWontools.com");
        vSeeds.emplace_back("seed-b.KoreaWon.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        fDefauKRWonsistencyChecks = true;
        fRequireStandard = false;
